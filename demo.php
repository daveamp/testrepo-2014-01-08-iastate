...
$featurearray = array("Gender" => array("female","male"),"Education" => array("no formal","4th grade","8th grade","high school","two-year college","college degree","graduate degree"),"Language Skills" => array("fluent English","broken English","tried English but unable","used interpreter"),"Country of Origin" => array("Germany","France","Mexico","Philippines","Poland","India","China","Sudan","Somalia","Iraq"),"Job" => array("janitor","waiter","child care provider","gardener","financial analyst","construction worker","teacher","computer programmer","nurse","research scientist","doctor"),"Job Experience" => array("none","1-2 years","3-5 years","5+ years"),"Job Plans" => array("contract with employer","interviews with employer","will look for work","no plans to look for work"),"Reason for Application" => array("reunite with family","seek better job","escape persecution"),"Prior Entry" => array("never","once as tourist","many times as tourist","six months with family","once w/o authorization"));

$restrictionarray = array(array(array("Job","financial analyst"),array("Education","no formal")),array(array("Job","financial analyst"),array("Education","4th grade")),array(array("Job","financial analyst"),array("Education","8th grade")),array(array("Job","financial analyst"),array("Education","high school")),array(array("Job","computer programmer"),array("Education","no formal")),array(array("Job","computer programmer"),array("Education","4th grade")),array(array("Job","computer programmer"),array("Education","8th grade")),array(array("Job","computer programmer"),array("Education","high school")),array(array("Job","research scientist"),array("Education","no formal")),array(array("Job","research scientist"),array("Education","4th grade")),array(array("Job","research scientist"),array("Education","8th grade")),array(array("Job","research scientist"),array("Education","high school")),array(array("Job","doctor"),array("Education","no formal")),array(array("Job","doctor"),array("Education","4th grade")),array(array("Job","doctor"),array("Education","8th grade")),array(array("Job","doctor"),array("Education","high school")),array(array("Reason for Application","escape persecution"),array("Country of Origin","Germany")),array(array("Reason for Application","escape persecution"),array("Country of Origin","France")),array(array("Reason for Application","escape persecution"),array("Country of Origin","Mexico")),array(array("Reason for Application","escape persecution"),array("Country of Origin","Poland")),array(array("Reason for Application","escape persecution"),array("Country of Origin","India")),array(array("Reason for Application","escape persecution"),array("Country of Origin","Philippines")));
...
$attrconstraintarray = array(array("Job","Job Experience","Job Plans"));
