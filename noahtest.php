...
$featurearray = array("Age." => array("35 years old.","40 years old.","50 years old.","60 years old.","70 years old."),"Gender." => array("Male.","Female."),"Completed Education." => array("High School.","College.","Law School."),"Marital Status." => array("Never been married.","Married.","Divorced."),"Race." => array("White","Latino","African American","Asian American"),"The government should ban assault weapons." => array("Strongly agree","Somewhat Agree","Somewhat Disagree","Strongly Disagree"),"The government should provide access to public land for gas and oil exploration." => array("Strongly agree","Somewhat Agree","Somewhat Disagree","Strongly Disagree"),"Policies to limit climate change will hurt our economy too much." => array("Strongly agree","Somewhat Agree","Somewhat Disagree","Strongly Disagree"),"We need to repeal the Trump tax cuts." => array("Strongly agree","Somewhat Agree","Somewhat Disagree","Strongly Disagree"),"Personal liabilities." => array("Embezzled $50,000","Caught on video laughing at a homeless man","Tore up a copy of the Constitution.","Viewed pornography after a campaign event","Nothing notable"));
